...
/* Antalet system är inte längre tre — gränsen läses ur COVSETS i stället
   för att stå i koden, annars hamnar varje nytt system tyst på nummer ett. */
function covSetIx(h){
  var v = CPICKS[h.id];
  return (typeof v === "number" && v > 0 && v < COVSETS.length) ? v : 0;
}
