...
/* ---------- 16 KAMPANJBYGGAREN ----------
   Tre ingångar till samma förlopp, och skillnaden är principiell:

     A  gränssnittet syns. Steget ritas som det ser ut.
     B  materialet leder. Samma steg sagt med bostaden i bild och
        gränssnittet bara antytt — för konton där en skärmbild känns
        teknisk i flödet.
     C  en mening. Kortast möjliga sätt att säga vad steget gör.

   Det gör valet till något annat än smaksak: A säljer verktyget, B
   säljer resultatet, C fungerar när rutan bara ska passera förbi. */
"byggaren-0":[
 {p:"editorial", m:"hero", k:"Kampanjbyggaren", h:"Kampanjen byggs på fem steg.",
  s:"Ur en order som redan är levererad — ingen ny fotografering, ingen ny text."},
 {p:"quiet", k:"16 — Kampanjbyggaren", h:"Materialet finns redan.", em:"Det som saknas är kampanjen.",
  s:"Fem steg, några minuter."}],

"byggaren-1":[
 {p:"editorial", m:"kitchen", k:"Steg 01 — Objekt", h:"Ordern är utgångspunkten.",
  s:"Varje levererad order ligger kvar med sina bilder. Kampanjen börjar i en av dem."},
 {p:"quiet", k:"Steg 01 — Objekt", h:"Välj objekt.", em:"Ur en order som redan är klar.",
  s:"Silvergården 9A · 42 bilder"}],

"byggaren-2":[
 {p:"system", k:"Steg 02 — Mallar", h:"Välj vad kampanjen ska bestå av.",
  s:"En eller flera. De fyra mallarna följer objektets vecka, och de går att kombinera fritt.",
  items:["Kommande — släpps snart","Till salu — med fakta","Visning — tid och plats","Såld — efteråt"]},
 {p:"quiet", k:"Steg 02 — Mallar", h:"Tre mallar.", em:"Eller en. Eller alla fyra.",
  s:"Kommande · Till salu · Visning · Såld"}],

"byggaren-3":[
 {p:"split", m:["kitchen","living"], la:"Ur ordern", lb:"Vald för mallen",
  k:"Steg 03 — Bilder", h:"En bild per mall."},
 {p:"quiet", k:"Steg 03 — Bilder", h:"En bild per mall.", em:"Ur ordern, inte ur en mapp.",
  s:"Mall för mall, tills alla har en."}],

"byggaren-4":[
 {p:"system", k:"Steg 04 — Kontroll", h:"Fyra rader att godkänna.",
  s:"Inget nytt att fylla i. Allt kommer från ordern och från valen i steg 01 till 03.",
  items:["Objekt — Silvergården 9A","Mallar — tre valda","Bilder — en per mall","Format — 4:5, 1:1 och 9:16"]},
 {p:"quiet", k:"Steg 04 — Kontroll", h:"Stämmer det?", em:"Då är kampanjen klar.",
  s:"Ingenting fylls i på nytt."}],

"byggaren-5":[
 {p:"editorial", m:"living", k:"Steg 05 — Klar", h:"Tre inlägg, nio filer.",
  s:"Varje mall exporteras i 4:5, 1:1 och 9:16 med objektets egna uppgifter i sig."},
 {p:"quiet", k:"Steg 05 — Klar", h:"Kampanjen är byggd.", em:"Några minuter, inte en eftermiddag.",
  s:"Tre mallar i tre format."}],

"byggaren-6":[
 {p:"system", k:"Dela och schemalägg", h:"Ut i kanalerna härifrån.",
  s:"Kontot ligger anslutet i studion. Kampanjen behöver inte gå omvägen via skrivbordet.",
  items:["Instagram — inlägg och story","Facebook — sida och grupp","Publicera nu","Schemalägg — tisdag 08:00"]},
 {p:"quiet", k:"Dela och schemalägg", h:"Publicera nu.", em:"Eller tisdag 08:00.",
  s:"Instagram och Facebook, direkt ur studion."}],

"byggaren-7":[
 {p:"mark", m:"kitchen", k:"KAMPANJBYGGAREN", h:"Fem steg", s:"Bygg kampanjen på viewly.se"},
 {p:"quiet", k:"16 — Kampanjbyggaren", h:"Bygg kampanjen.", em:"Materialet har du redan.",
  s:"viewly.se"}],
};
