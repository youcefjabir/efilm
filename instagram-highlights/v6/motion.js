...
var MCAND = [
 ...
 {id:"bygg", num:"08", n:"Kampanjen, steg för steg", ref:["kampanjen",1], prim:"phases",
  claim:"Fyra steg från order till publicerad kampanj.",
  rank:"Det starkaste skälet i biblioteket att göra rörligt alls. Flödet ÄR produkten: en stillbild kan bara visa ett steg av fyra. Mallarna som syns är de riktiga, inte platshållare."}
];
...
var MSTORY = {
 bygg:{
  stillhet:[["0,0 s","Mallen Kommande i 84 cqw, alltså den riktiga artboarden nedskalad. Under den Välj objekt i Cormorant och en rad. Ingen räknare, inga markeringar."],
   ["1,8 s","Mallen byts maskerat från vänster och rubriken går till Välj mallar."],
   ["3,6 s","Till salu. Välj bilder."],
   ["5,4 s","Visning. Klar — dela direkt eller schemalägg."],
   ["7,2 s","Slutbild med märket."]],
  editorial:[["0,0 s","Räknaren överst: fyra streck och 01 / 04. Under den Välj objekt stort, en rad text, och de tre ordrarna som ren typografi — ingen lista, inga rutor."],
   ["1,8 s","Steg 02. Kontorets fyra riktiga mallar ligger i rad, tre markerade med en liten fylld kvadrat. Att mallarna är de faktiska artboardsen och inte platshållare är hela poängen."],
   ["3,6 s","Steg 03. En mall i stor skala, orderns bilder som en rad under, en markerad."],
   ["5,4 s","Steg 04. De tre färdiga mallarna, och under dem Ut i Instagram och Facebook. Två ord, ingen panel."],
   ["7,2 s","Slutbild."]],
  system:[["0,0 s","Rubrik: Fyra steg. Under den fyra rader, alla släckta utom den första."],
   ["1,8 s","02 Välj mallar tänds. Alla fyra syns hela tiden — det säger hur många steg det är och att det tar slut."],
   ["3,6 s","03 Välj bilder."],
   ["5,4 s","04 Klar."],
   ["7,2 s","Slutbild med alla fyra tända."]],
  object:[["0,0 s","De fyra riktiga mallarna ligger uppe hela klippet, alla lika dämpade. Under dem ordrarna."],
   ["1,8 s","Tre av mallarna tänds och får en olivkant. Den fjärde tonas ner. Valet syns i mallarna själva, inte i ett gränssnitt."],
   ["3,6 s","Den valda mallen växer fram i stor skala under raden."],
   ["5,4 s","Sista mallen. Kampanjen är byggd."],
   ["7,2 s","Slutbild."]]},
 annons:{
 ...
 white:{
  stillhet:[["0,0 s","Visningssidan i 4:3 med generös marginal. Under den kontorets namn spärrat och <i>Er visningssida</i> i Cormorant. Inget annat."],
   ["2,0 s","Nästa kontor sveper in maskerat från vänster. Logotypen byter platta och färg, adressen byter typsnitt, knappen byter form. Bostaden och mäklaren rör sig inte."],
   ["4,0 s","Tredje kontoret."],
   ["6,0 s","Fjärde."],
   ["8,0 s","Slutbild."]],
  editorial:[["0,0 s","Sidan i full bredd, 16:9. Kicklinjen namnger kontoret. Under plåten står namnet i Cormorant och en rad om vad som byts."],
   ["2,1 s","Bytet sker under en vandrande kant. Tre saker ändras samtidigt: logotypens platta och färg, typsnittet i adress och knapp, och knappens fyllning och hörnradie."],
   ["4,2 s","Tredje kontoret — här går knappen från fylld till konturad och spärrningen ökar."],
   ["6,3 s","Fjärde."],
   ["8,4 s","Slutbild: <i>Logotyp, typsnitt och knapp är kontorets. Bostaden, adressen och mäklaren står still.</i>"]],
  system:[["0,0 s","Bytet isärplockat. Tre rutor under varandra: 01 Logotyp, 02 Typsnitt, 03 Knapp. Var och en visar bara den delen, i stor skala."],
   ["2,0 s","Kontoret byts och alla tre rutorna följer med i samma ruta. Att de hör ihop är hela poängen — det är inte tre inställningar utan ett uttryck."],
   ["4,0 s","Tredje kontoret. Typsnittet går från grotesk till antikva och knappen blir rundad."],
   ["6,0 s","Fjärde: konturad knapp, spärrad versal logotyp."],
   ["8,0 s","Slutbild."]],
  object:[["0,0 s","Samma sida i tre bildförhållanden samtidigt: 16:9 desktop överst, 4:3 surfplatta och 9:16 mobil under. Alla tre är sidan, inte tre sidor."],
   ["2,2 s","Läget vandrar till surfplattan. Ingen skalning, bara ram och ljusstyrka."],
   ["4,4 s","Mobilen. Adressen och knappen sitter kvar i mitten, kontaktvägarna flyttar aldrig."],
   ["5,8 s","Brödtext: <i>Desktop, surfplatta och mobil är inte tre sidor. Det är en, som sätter om sig.</i>"]]},
 tredim:{
  stillhet:[["0,0 s","Visningssidan i 4:3. Under den ett klockslag spärrat — 06:40 · Före jobbet — och <i>Alltid öppen</i> i Cormorant."],
   ["2,7 s","Klockslaget byts maskerat till 14:15 · Från en annan stad. Sidan är densamma. Det är hela argumentet: bostaden ändrar sig inte, tiden gör det."],
   ["5,4 s","23:20 · Efter läggdags."],
   ["8,0 s","Slutbild: <i>Bostaden går att uppleva när som helst.</i>"]],
  editorial:[["0,0 s","Sidan i 16:9 med bostaden i. Under den en urtavla som visar 06:40 och tiden satt i Cormorant."],
   ["2,2 s","Visningen byter rum och klockan går till 14:15. Urtavlans visare flyttar sig, inte hela plåten."],
   ["4,4 s","23:20. Tredje rummet."],
   ["6,6 s","Slutbild: <i>Bostaden är alltid öppen.</i> En fysisk visning är öppen en timme på söndag. Den här är öppen alltid, och det är skillnaden som säljer."]],
  system:[["0,0 s","Rubrik: <i>Bostaden säljer medan du sover.</i> Sidan liten överst, sedan fyra effekter under varandra, alla släckta utom den första."],
   ["2,0 s","Fler når objektet tänds."],
   ["4,0 s","Bättre visningar."],
   ["6,0 s","Måtten finns i sidan."],
   ["6,6 s","Slutbild med alla fyra tända. Effekter, inte funktioner — ingen mäklare köper en flikrad."]],
  object:[["0,0 s","Sidan i 4:3, nästan hela ramen. Rubriken står på pappret under: <i>Gå in när du vill.</i>"],
   ["2,2 s","Bostaden i sidan byts maskerat och rubriken går till <i>Gå igenom varje rum.</i>"],
   ["4,4 s","<i>Mät medan du går.</i> Måtten finns i sidan."],
   ["6,6 s","Slutbild."]]}
